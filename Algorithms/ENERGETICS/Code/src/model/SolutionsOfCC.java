...
public class SolutionsOfCC {
	...
	public boolean doesCoverSolutionExist(OpenBitSet k, OpenBitSet kUnionCand, double maxSim) {
	...
	public boolean doesCoverSolutionExistUsingUB1(OpenBitSet k, OpenBitSet kUnionCand, double maxSim, int n) {
		for (OneSolution solution : solutionsOfVertices) {
